    ...
    <div className="mx-auto w-full max-w-md px-6 py-16">
      ...
      <div className="mt-8 space-y-3">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-md border border-border py-2.5 text-sm font-medium text-foreground/40 cursor-not-allowed"
        >
      ...
      <div className="mt-6 flex items-start gap-3 rounded-lg bg-amber-50/70 p-4">
        ...
        <p className="text-sm text-foreground/80">
          Paying via M-Pesa? Sign in first to unlock your courses and downloads instantly after payment
          confirmation.
        </p>
      </div>
